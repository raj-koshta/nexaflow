    ...
    <div class="card-body p-0">
        <div class="table-responsive">
            <table class="table mb-0">
                <thead>
                    <tr>
                        <th class="border-bottom-0 py-3" style="width: 30%"><div class="skeleton-box rounded" style="width: 60%; height: 16px;"></div></th>
                        <th class="border-bottom-0 py-3" style="width: 20%"><div class="skeleton-box rounded" style="width: 50%; height: 16px;"></div></th>
                        <th class="border-bottom-0 py-3" style="width: 15%"><div class="skeleton-box rounded" style="width: 60%; height: 16px;"></div></th>
                        <th class="border-bottom-0 py-3" style="width: 15%"><div class="skeleton-box rounded" style="width: 60%; height: 16px;"></div></th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="py-3">
                            <div class="skeleton-box rounded-pill mb-2" style="width: 70px; height: 24px;"></div>
                            <div class="skeleton-box rounded-pill" style="width: 60px; height: 20px;"></div>
                        </td>
